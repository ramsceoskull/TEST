...
<head>
	...
	<link rel="icon" href="./assets/icons/home-white.png">
...
<body>
  ...
  <aside class="mobile-menu">
		<nav class="menu__content">
			<label for="btn-menu"><img src="./assets/close-icon.svg" alt="close button"></label>
			<section class="upperSection">
				<!-- <ul>
					<li><h3>CATEGORIAS</h3></li>
					<li><a href="./email/sent.html">Todo</a></li>
	...
	<div class="splicer">
		<section class="blanco contenedor">
			...
			<div class="frame-slider">
				<ul>
					<!-- <li><img src="./assets/images/Profesional-Asociado-en-Panaderia.jpg" alt=""></li>
					<li><img src="./assets/images/reposteros-mexicanos-maricu-ortiz.jpg" alt=""></li> -->
		...
		<section class="negro contenedor">
			...
			<div class="frame-slider">
				<ul>
					<!-- <li><img src="./assets/images/tecnicas-de-reposteria-2-1024x576.jpg" alt=""></li>
					<li><img src="./assets/images/reposteria-vegana-1280x850.jpg" alt=""></li> -->
